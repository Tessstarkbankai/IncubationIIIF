      ...
      <div className=' hidden h-[400px] bg-gradient-to-r from-blue-100 to-blue-200 sm:flex justify-center gap-14' >
        ...
        <div className="about ml-[90px] w-[350px] mt-[30px] leading-10 font-sans text-lg text-blue-600">
          ...
          <div className=' flex gap-4 mt-2 hover:cursor-pointer' >
            ...
            <a href=" https://whatsapp.com/channel/0029VaXNIlp3gvWd2SqE102s " target="_blank"><svg className='scale-100 transition duration-300 hover:scale-150' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
