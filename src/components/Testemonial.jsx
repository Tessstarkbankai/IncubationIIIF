  ...
  return (
    ...
    >
      <div className=' flex sm:flex-row flex-col justify-center p-4 sm:gap-[100px] gap-2'>
        <img className='m-auto sm:m-0 w-[200px] sm:w-[450px] sm:h-[420px] h-[180px] ' src={parthSir} alt="" />
      <div className=" sm:mt-24 pointer-events-none whitespace-pre-wrap bg-gradient-to-r from-black to-blue-300/80 bg-clip-text text-center sm:text-4xl text-xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10">
        <span className=' whitespace-pre-wrap bg-gradient-to-b from-black to-blue-300/90 bg-clip-text'>By Executive Director</span>
        <div className='sm:text-xl text-sm text-center sm:mt-11 mt-4 ' >I am incredibly proud of our incubation center for fostering innovation and entrepreneurship among our students. Your dedication to nurturing young talent is truly inspiring. Let's continue to create an environment where ideas flourish and businesses thrive.
